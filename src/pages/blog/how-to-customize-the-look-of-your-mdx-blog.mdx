---
title:  How to customize the look of your MDX Gastby blog
date: 2021-07-31
---

# How to customize the look of your MDX Gastby blog
...
Not sure why would someone want to do this, but you can for example render evenry `h1` as an image or Rick Astley... you get the idea of how powerfull this can be:
...
Mdx passes the string that's next to the tripple backticks as a class of our custom component, `language-${name}`:
