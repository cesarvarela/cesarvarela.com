...
date: 2021-08-13
---
I'm about to release my first Elecontron-Based Open Source App (EBOSA?), for which you can read more about it [here](/stahp). And after fighting a bit with `electron-forge,` I'm reaching the last steps.

Codesigning is one of them, and if you are not used to Desktop environments, there is a lot of jargon and confusion waiting for you.
